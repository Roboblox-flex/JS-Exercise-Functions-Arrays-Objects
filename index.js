...
function temperatureCtoF(temp) {
  const fahrenhiet = Math.round((temp * 9) / 5 + 32);
  return fahrenhiet;
}
 ...
 */
function temperatureInF(temp, corf) {
...
console.log(temperatureInF(36, "f"));
/**
...
console.log(makePersonObject(22, "ming", "blabla@gmail.com"));
/**
 * ### Challenge `getName`
 *
 * @instructions
...
console.log(["orange", "grape", "apple", "banana", "mango"]);
/**
